	...
	tilepal 0, BROWN, WATER, GRAY, BROWN, BROWN, BROWN, GRAY, GRAY
	tilepal 0, GRAY, BROWN, BROWN, GRAY, BROWN, GRAY, GRAY, BROWN
	tilepal 0, BROWN, BROWN, GRAY, GRAY, BROWN, BROWN, GRAY, TEXT
	tilepal 1, GRAY, GRAY, BROWN, BROWN, RED, RED, RED, RED
	...
	tilepal 1, GREEN, BROWN, GRAY, GRAY, GRAY, GRAY, GRAY, BROWN
	tilepal 1, RED, GRAY, GREEN, GREEN, GREEN, GREEN, GREEN, GREEN
	tilepal 1, GREEN, GRAY, GRAY, GRAY, GRAY, GRAY, GRAY, BROWN
	tilepal 1, RED, RED, YELLOW, GREEN, GREEN, GREEN, GREEN, WATER
	tilepal 1, WATER, WATER, WATER, BROWN, BROWN, BROWN, BROWN, BROWN
	tilepal 1, RED, RED, BROWN, GREEN, GREEN, GREEN, GREEN, WATER
	tilepal 1, WATER, BROWN, WATER, BROWN, BROWN, BROWN, BROWN, BROWN
	tilepal 1, GRAY, GRAY, BROWN, GREEN, GREEN, GREEN, GREEN, WATER
	tilepal 1, TEXT, TEXT, WATER, TEXT, TEXT, TEXT, TEXT, TEXT
	tilepal 1, TEXT, TEXT, TEXT, GREEN, BROWN, BROWN, GREEN, WATER
	tilepal 1, WATER, WATER, WATER, TEXT, TEXT, TEXT, TEXT, GRAY
