...
.FlyPoint:
	setflag ENGINE_FLYPOINT_SECUNDA
	return
...
.FinishRival3:
	...
	setmapscene SECUNDA_CITY, SCENE_SECUNDACITY_NOTHING
	special HealParty
	playmapmusic
	end
