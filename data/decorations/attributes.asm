...
; entries correspond to deco constants
	...
	decoration DECO_POSTER,  NOIBAT,       SET_UP_POSTER,     EVENT_DECO_POSTER_2,             $24
	...
	decoration DECO_BIGDOLL, HAWLUCHA,       SET_UP_BIG_DOLL,   EVENT_DECO_BIG_ONIX_DOLL,        SPRITE_BIG_ONIX
	...
	decoration DECO_DOLL,    NOIBAT,       SET_UP_DOLL,       EVENT_DECO_CLEFAIRY_DOLL,        SPRITE_CLEFAIRY
	decoration DECO_DOLL,    JIGGLYPUFF,     SET_UP_DOLL,       EVENT_DECO_JIGGLYPUFF_DOLL,      SPRITE_JIGGLYPUFF
	decoration DECO_DOLL,    BELDUM,         SET_UP_DOLL,       EVENT_DECO_BULBASAUR_DOLL,       SPRITE_BULBASAUR
	decoration DECO_DOLL,    BAGON,          SET_UP_DOLL,       EVENT_DECO_CHARMANDER_DOLL,      SPRITE_CHARMANDER
	decoration DECO_DOLL,    TRAPINCH,       SET_UP_DOLL,       EVENT_DECO_SQUIRTLE_DOLL,        SPRITE_SQUIRTLE
	...
	decoration DECO_DOLL,    FEEBAS,         SET_UP_DOLL,       EVENT_DECO_SHELLDER_DOLL,        SPRITE_SHELLDER
	decoration DECO_DOLL,    GRIMER,         SET_UP_DOLL,       EVENT_DECO_GRIMER_DOLL,          SPRITE_GRIMER
	decoration DECO_DOLL,    TOGEKISS,        SET_UP_DOLL,       EVENT_DECO_VOLTORB_DOLL,         SPRITE_VOLTORB
	...
	decoration DECO_DOLL,    GOOMY,          SET_UP_DOLL,       EVENT_DECO_MACHOP_DOLL,          SPRITE_MACHOP
