...
.JohtoStarters: db BUENA_MON,    10, CYNDAQUIL, TOTODILE, ROWLET
...
.Pokemon1:      db BUENA_MON,    10, PIKACHU, ZIGZAGOON, GEODUDE
.Pokemon2:      db BUENA_MON,    10, HOOTHOOT, SPINARAK, MAGMORTOR
