...
MapGroup_Pallet:
	...
	map RedsHouse1F, TILESET_PLAYERS_HOUSE, INDOOR, NEW_BARK_TOWN, MUSIC_PALLET_TOWN, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map RedsHouse2F, TILESET_PLAYERS_HOUSE, INDOOR, NEW_BARK_TOWN, MUSIC_PALLET_TOWN, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Cherrygrove:
	...
	map SecundaCemetary, TILESET_TSUJI, ROUTE, CHERRYGROVE_CITY, MUSIC_ROUTE_12, FALSE, PALETTE_AUTO, FISHGROUP_DRATINI
