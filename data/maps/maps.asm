...
MapGroup_Dungeons:
	...
	map RuinsOfAlphKabutoWordRoom, TILESET_RUINS_OF_ALPH, DUNGEON, RUINS_OF_ALPH, MUSIC_UNION_CAVE, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map RuinsOfAlphAerodactylWordRoom, TILESET_BATTLE_TOWER, DUNGEON, RUINS_OF_ALPH, MUSIC_UNION_CAVE, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map SecundaForest, TILESET_FOREST, ROUTE, SECUNDA_FOREST, MUSIC_DARK_CAVE, FALSE, PALETTE_AUTO, FISHGROUP_NONE
	map SecundaRuins1F, TILESET_RUINS, DUNGEON, SECUNDA_FOREST, MUSIC_RUINS_OF_ALPH_INTERIOR, FALSE, PALETTE_DAY, FISHGROUP_GYARADOS
...
MapGroup_Ecruteak:
	...
	map Route103, TILESET_TSUJI, ROUTE, ECRUTEAK_CITY, MUSIC_ROUTE_36, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN
	map MonithTown, TILESET_TSUJI, TOWN, ECRUTEAK_CITY, MUSIC_ECRUTEAK_CITY, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN
	map Route104, TILESET_TSUJI, ROUTE, ECRUTEAK_CITY, MUSIC_ROUTE_37, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN
	map Route104Landing, TILESET_TSUJI, ROUTE, ECRUTEAK_CITY, MUSIC_ROUTE_37, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN
...
MapGroup_Azalea:
	...
	map UreCity, TILESET_BATTLE_TOWER_OUTSIDE, TOWN, AZALEA_TOWN, MUSIC_ANVILLE_TOWN, FALSE, PALETTE_AUTO, FISHGROUP_NONE
	map Route102FishingLake, TILESET_BATTLE_TOWER_OUTSIDE, ROUTE, ROUTE_102, MUSIC_ROUTE_30, FALSE, PALETTE_AUTO, FISHGROUP_DRATINI
	map FishingLakeInterior, TILESET_PORT, INDOOR, ROUTE_102, MUSIC_ROUTE_30, FALSE, PALETTE_AUTO, FISHGROUP_LAKE
...
MapGroup_Violet:
	...
	map EeveeHouseLanding, TILESET_TRADITIONAL_HOUSE, INDOOR, VIOLET_CITY, MUSIC_ECRUTEAK_CITY, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map EeveeHouseGarden, TILESET_TRADITIONAL_HOUSE, INDOOR, VIOLET_CITY, MUSIC_ECRUTEAK_CITY, FALSE, PALETTE_AUTO, FISHGROUP_NONE
	map EeveeHouseHall, TILESET_TRADITIONAL_HOUSE, INDOOR, VIOLET_CITY, MUSIC_ECRUTEAK_CITY, FALSE, PALETTE_AUTO, FISHGROUP_NONE
	map EeveeHouse, TILESET_BATTLE_TOWER_OUTSIDE, ROUTE, VIOLET_CITY, MUSIC_DANCING_HALL, FALSE, PALETTE_AUTO, FISHGROUP_DRATINI
...
MapGroup_Goldenrod:
	...
	map CenturmCity, TILESET_BATTLE_TOWER_OUTSIDE, TOWN, GOLDENROD_CITY, MUSIC_WHITE_TREEHOLLOW, FALSE, PALETTE_AUTO, FISHGROUP_DRATINI_2
	map Route104West, TILESET_BATTLE_TOWER_OUTSIDE, ROUTE, PALLET_TOWN, MUSIC_ROUTE_3, FALSE, PALETTE_AUTO, FISHGROUP_DRATINI_2
...
MapGroup_Pallet:
	...
	map RedsHouse1F, TILESET_PLAYERS_HOUSE, INDOOR, NEW_BARK_TOWN, MUSIC_NEW_BARK_TOWN, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map RedsHouse2F, TILESET_PLAYERS_HOUSE, INDOOR, NEW_BARK_TOWN, MUSIC_NEW_BARK_TOWN, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_NewBark:
	...
	map Route101, TILESET_TSUJI, ROUTE, ROUTE_101, MUSIC_ROUTE_29, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map NewBarkTown, TILESET_TSUJI, TOWN, NEW_BARK_TOWN, MUSIC_NEW_BARK_TOWN, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN
	map ElmsLab, TILESET_LAB, INDOOR, ROUTE_101, MUSIC_PROF_ELM, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map ElmsHouse, TILESET_PLAYERS_HOUSE, INDOOR, ROUTE_101, MUSIC_NEW_BARK_TOWN, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map Route29Route46Gate, TILESET_GATE, GATE, ROUTE_46, MUSIC_ROUTE_29, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map MapleLab, TILESET_TSUJI, ROUTE, ROUTE_101, MUSIC_ROUTE_29, FALSE, PALETTE_AUTO, FISHGROUP_DRATINI
	map SecundaForest101, TILESET_TSUJI, ROUTE, ROUTE_101, MUSIC_ROUTE_29, FALSE, PALETTE_AUTO, FISHGROUP_NONE
	map SecundaForestGate1, TILESET_GATE, GATE, ROUTE_101, MUSIC_ROUTE_29, FALSE, PALETTE_DAY, FISHGROUP_NONE
...
MapGroup_Secunda:
	map SecundaCity, TILESET_TSUJI, TOWN, SECUNDA_CITY, MUSIC_VIOLET_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map CherrygroveMart, TILESET_MART, INDOOR, SECUNDA_CITY, MUSIC_VIOLET_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CherrygrovePokecenter1F, TILESET_POKECENTER, INDOOR, SECUNDA_CITY, MUSIC_POKEMON_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CherrygroveGymSpeechHouse, TILESET_HOUSE, INDOOR, SECUNDA_CITY, MUSIC_VIOLET_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CherrygroveEvolutionSpeechHouse, TILESET_HOUSE, INDOOR, SECUNDA_CITY, MUSIC_VIOLET_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SecundaForestGate2, TILESET_GATE, GATE, SECUNDA_FOREST, MUSIC_DARK_CAVE, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SecundaCemetary, TILESET_TSUJI, ROUTE, SECUNDA_CITY, MUSIC_LAVENDER_TOWN, FALSE, PALETTE_AUTO, FISHGROUP_DRATINI
	map SecundaGym, TILESET_GYM_ARENA, INDOOR, SECUNDA_CITY, MUSIC_GYM, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map FlowerHouse, TILESET_HOUSE, INDOOR, SECUNDA_CITY, MUSIC_LAVENDER_TOWN, FALSE, PALETTE_DAY, FISHGROUP_DRATINI
