...
MapGroup_Dungeons:
	...
	map SecundaForest, TILESET_FOREST, DUNGEON, SECUNDA_FOREST, MUSIC_DARK_CAVE, FALSE, PALETTE_AUTO, FISHGROUP_NONE
...
MapGroup_Goldenrod:
	...
	map Route104West, TILESET_BATTLE_TOWER_OUTSIDE, ROUTE, ROUTE_34, MUSIC_ROUTE_3, FALSE, PALETTE_AUTO, FISHGROUP_DRATINI_2
