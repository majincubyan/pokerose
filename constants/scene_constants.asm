...
; wSecundaForestSceneID
	const_def 1
	const SCENE_FOREST_ETERNITY
	const SCENE_FOREST_NOTHING

; wSecundaRuins1FSceneID
	const_def 1
	const SCENE_RUINS_NOTHING
	const SCENE_RUINS_ETERNAL_TAKEOVER
