...
; Johto story events
	...
	const EVENT_GOT_BERRY_FROM_MAPLE_HOUSE
	...
	const EVENT_TALKED_TO_ATM_FIRST_TIME ; 040
...
; ???
	const EVENT_FOREST_COACH_TALKED
	const EVENT_FOREST_COACH_BEAT
	const EVENT_RUINS_1F_ROCKS_CLEARED
	const EVENT_BEAT_RUINS_ADMIN
	const EVENT_RUINS_CELEBI_1
	const EVENT_HUSBAND_OUTSIDE_RUINS
	const EVENT_HOOH_PUZZLE_SECUNDA_OPEN
	const EVENT_GOT_SAMPLE_ITEMS
	const EVENT_GOT_FORESTBADGE
	const EVENT_GOT_PINK_ROSE
	const EVENT_GAVE_PINK_ROSE
	const EVENT_BEAT_CURMUDGEON_LESLIE
	const EVENT_BEAT_CURMUDGEON_LIONEL
	const EVENT_BEAT_DELINQUENT_SHINJI
	const EVENT_FLOWER_GRANDMA_GONE
	const EVENT_GOT_CEMETARY_PROTECT
	const EVENT_GOT_CEMETARY_GREAT_BALL
	const EVENT_GOT_FOREST_NUGGET
	const EVENT_GOT_FOREST_AWAKENING
	const EVENT_GOT_SECUNDA_CITY_RARE_CANDY
	const EVENT_119
	const EVENT_11A
	const EVENT_11B
	const EVENT_11C
...
; Bird Keeper
	...
	const EVENT_BEAT_YOUNGSTER_KEN
...
; PeonM
	const EVENT_BEAT_ETERNAL_PEONM_1
	const EVENT_BEAT_ETERNAL_PEONM_2
	const EVENT_BEAT_ETERNAL_PEONM_3
	const EVENT_BEAT_ETERNAL_PEONM_4
	const EVENT_BEAT_ETERNAL_PEONM_5
	const EVENT_BEAT_ETERNAL_PEONM_6
	const EVENT_BEAT_ETERNAL_PEONM_7
	const EVENT_BEAT_ETERNAL_PEONM_8
	const EVENT_BEAT_ETERNAL_PEONM_9
	const EVENT_BEAT_ETERNAL_PEONM_10
	const EVENT_BEAT_ETERNAL_PEONM_11
	const EVENT_BEAT_ETERNAL_PEONM_12
	const EVENT_BEAT_ETERNAL_PEONM_13
	const EVENT_BEAT_ETERNAL_PEONM_14
	const EVENT_BEAT_ETERNAL_PEONM_15
	const EVENT_BEAT_ETERNAL_PEONM_16
	const EVENT_BEAT_ETERNAL_PEONM_17
	const EVENT_BEAT_ETERNAL_PEONM_18
	const EVENT_BEAT_ETERNAL_PEONM_19
	const EVENT_BEAT_ETERNAL_PEONM_20
	const EVENT_BEAT_ETERNAL_PEONM_21
	const EVENT_BEAT_ETERNAL_PEONM_22
	const EVENT_BEAT_ETERNAL_PEONM_23
	const EVENT_BEAT_ETERNAL_PEONM_24
	const EVENT_BEAT_ETERNAL_PEONM_25
	const EVENT_BEAT_ETERNAL_PEONM_26
	const EVENT_BEAT_ETERNAL_PEONM_27
	const EVENT_BEAT_ETERNAL_PEONM_28
	const EVENT_BEAT_ETERNAL_PEONM_29
	const EVENT_BEAT_ETERNAL_PEONM_30
	const EVENT_BEAT_ETERNAL_PEONM_31
; PeonF
	const EVENT_BEAT_ETERNAL_PEONF_1
	const EVENT_BEAT_ETERNAL_PEONF_2
	const EVENT_BEAT_ETERNAL_PEONF_3
	const EVENT_BEAT_ETERNAL_PEONF_4
	const EVENT_BEAT_ETERNAL_PEONF_5
; Lass
...
; Johto people
	const EVENT_NEL_MINUT_TOWN
	const EVENT_NEL_LAB_OUTSIDE
